    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24 }}>
        ...
        <View className="px-6 mt-2">
          <View className="w-full rounded-3xl bg-white px-8 py-8 items-center shadow-sm border border-gray-100">
            <View className="w-16 h-16 rounded-2xl bg-indigo-100 items-center justify-center mb-6">
