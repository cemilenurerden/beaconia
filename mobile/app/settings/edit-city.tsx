  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50 dark:bg-slate-900">
      <View className="flex-row items-center justify-between px-6 pt-4 pb-2">
        ...
        <Text className="text-lg font-bold text-gray-900 dark:text-white">Şehir Değiştir</Text>
        <View style={{ width: 24 }} />
      </View>

      <View className="mx-4 mt-6">
        <Text className="text-sm font-medium text-gray-600 dark:text-slate-400 mb-2">Şehir</Text>
        <TextInput
          value={city}
